...
const Hero = () => {
	...
	return (
		<section className="min-h-screen w-full flex flex-col md:flex-row md:items-end justify-between py-10 lg:py-20 gap-12">
			<motion.div
				initial="hidden"
				animate="visible"
				variants={heroItems}
				className="flex flex-col justify-end md:max-w-md lg:max-w-xl gap-6 grow"
			>
			...
			<div className="relative flex items-end w-20 h-20 lg:w-16 lg:h-16">
				<Image
					src={scrolldown}
					alt="Scroll Down"
